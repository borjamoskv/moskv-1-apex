...
class SessionInitializer:
    ...
    def generate_state(self, platform: str, target_url: str):
        ...
        print(f"[*] Una vez autenticado, cierra la ventana del navegador. El estado será guardado criptográficamente.")
        ...
        with sync_playwright() as p:
            ...
            print(f"[+] Estado de sesión volcado y blindado en: {state_file}")
